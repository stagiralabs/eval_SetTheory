...
theorem eta (o : WellOrder) : mk o.α o.r o.wo = o := by sorry
...
@[target, simp]
theorem type_toType (o : Ordinal) : typeLT o.toType = o := by sorry

@[target, deprecated type_toType (since := "2024-10-22")]
theorem type_lt (o : Ordinal) : typeLT o.toType = o := by sorry

@[target, deprecated type_toType (since := "2024-08-26")]
theorem type_out (o : Ordinal) : Ordinal.type o.out.r = o := by sorry

@[target]
theorem type_eq {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r] [IsWellOrder β s] :
    type r = type s ↔ Nonempty (r ≃r s) := by sorry

@[target]
theorem _root_.RelIso.ordinal_type_eq {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r]
    [IsWellOrder β s] (h : r ≃r s) : type r = type s := by sorry

@[target]
theorem type_eq_zero_of_empty (r) [IsWellOrder α r] [IsEmpty α] : type r = 0 := by sorry

@[target, simp]
theorem type_eq_zero_iff_isEmpty [IsWellOrder α r] : type r = 0 ↔ IsEmpty α := by sorry

@[target]
theorem type_ne_zero_iff_nonempty [IsWellOrder α r] : type r ≠ 0 ↔ Nonempty α := by sorry

@[target]
theorem type_ne_zero_of_nonempty (r) [IsWellOrder α r] [h : Nonempty α] : type r ≠ 0 := by sorry

@[target]
theorem type_pEmpty : type (@EmptyRelation PEmpty) = 0 := by sorry

@[target]
theorem type_empty : type (@EmptyRelation Empty) = 0 := by sorry

@[target]
theorem type_eq_one_of_unique (r) [IsWellOrder α r] [Nonempty α] [Subsingleton α] : type r = 1 := by sorry

@[target, simp]
theorem type_eq_one_iff_unique [IsWellOrder α r] : type r = 1 ↔ Nonempty (Unique α) := by sorry

@[target]
theorem type_pUnit : type (@EmptyRelation PUnit) = 1 := by sorry

@[target]
theorem type_unit : type (@EmptyRelation Unit) = 1 := by sorry

@[target, simp]
theorem toType_empty_iff_eq_zero {o : Ordinal} : IsEmpty o.toType ↔ o = 0 := by sorry

@[deprecated toType_empty_iff_eq_zero (since := "2024-08-26")]
alias out_empty_iff_eq_zero := toType_empty_iff_eq_zero

@[target, deprecated toType_empty_iff_eq_zero (since := "2024-08-26")]
theorem eq_zero_of_out_empty (o : Ordinal) [h : IsEmpty o.toType] : o = 0 := by sorry

instance isEmpty_toType_zero : IsEmpty (toType 0) :=
  toType_empty_iff_eq_zero.2 rfl

@[target, simp]
theorem toType_nonempty_iff_ne_zero {o : Ordinal} : Nonempty o.toType ↔ o ≠ 0 := by sorry

@[deprecated toType_nonempty_iff_ne_zero (since := "2024-08-26")]
alias out_nonempty_iff_ne_zero := toType_nonempty_iff_ne_zero

@[target, deprecated toType_nonempty_iff_ne_zero (since := "2024-08-26")]
theorem ne_zero_of_out_nonempty (o : Ordinal) [h : Nonempty o.toType] : o ≠ 0 := by sorry
...
theorem inductionOn {C : Ordinal → Prop} (o : Ordinal)
    (H : ∀ (α r) [IsWellOrder α r], C (type r)) : C o := by sorry
...
theorem inductionOn₂ {C : Ordinal → Ordinal → Prop} (o₁ o₂ : Ordinal)
    (H : ∀ (α r) [IsWellOrder α r] (β s) [IsWellOrder β s], C (type r) (type s)) : C o₁ o₂ := by sorry
...
theorem inductionOn₃ {C : Ordinal → Ordinal → Ordinal → Prop} (o₁ o₂ o₃ : Ordinal)
    (H : ∀ (α r) [IsWellOrder α r] (β s) [IsWellOrder β s] (γ t) [IsWellOrder γ t],
      C (type r) (type s) (type t)) : C o₁ o₂ o₃ := by sorry
...
theorem inductionOnWellOrder {C : Ordinal → Prop} (o : Ordinal)
    (H : ∀ (α) [LinearOrder α] [WellFoundedLT α], C (typeLT α)) : C o := by sorry
...
theorem liftOnWellOrder_type {δ : Sort v} (f : ∀ (α) [LinearOrder α] [WellFoundedLT α], δ)
    ...
    liftOnWellOrder (typeLT γ) f c = f γ := by sorry
...
theorem _root_.RelEmbedding.ordinal_type_le {α β} {r : α → α → Prop} {s : β → β → Prop}
    [IsWellOrder α r] [IsWellOrder β s] (h : r ↪r s) : type r ≤ type s := by sorry

@[target]
theorem _root_.PrincipalSeg.ordinal_type_lt {α β} {r : α → α → Prop} {s : β → β → Prop}
    [IsWellOrder α r] [IsWellOrder β s] (h : r ≺i s) : type r < type s := by sorry
...
@[target, simp]
theorem bot_eq_zero : (⊥ : Ordinal) = 0 := by sorry
...
theorem type_le_iff {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r]
    [IsWellOrder β s] : type r ≤ type s ↔ Nonempty (r ≼i s) := by sorry

@[target]
theorem type_le_iff' {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r]
    [IsWellOrder β s] : type r ≤ type s ↔ Nonempty (r ↪r s) := by sorry
...
theorem type_subrel (r : α → α → Prop) [IsWellOrder α r] (a : α) :
    type (Subrel r (r · a)) = typein r a := by sorry

@[target, simp]
theorem top_typein (r : α → α → Prop) [IsWellOrder α r] : (typein r).top = type r := by sorry

@[target]
theorem typein_lt_type (r : α → α → Prop) [IsWellOrder α r] (a : α) : typein r a < type r := by sorry
...
theorem typein_top {α β} {r : α → α → Prop} {s : β → β → Prop}
    [IsWellOrder α r] [IsWellOrder β s] (f : r ≺i s) : typein s f.top = type r := by sorry

@[target, simp]
theorem typein_lt_typein (r : α → α → Prop) [IsWellOrder α r] {a b : α} :
    typein r a < typein r b ↔ r a b := by sorry

@[target, simp]
theorem typein_le_typein (r : α → α → Prop) [IsWellOrder α r] {a b : α} :
    typein r a ≤ typein r b ↔ ¬r b a := by sorry

@[target]
theorem typein_injective (r : α → α → Prop) [IsWellOrder α r] : Injective (typein r) := by sorry

@[target]
theorem typein_inj (r : α → α → Prop) [IsWellOrder α r] {a b} : typein r a = typein r b ↔ a = b := by sorry

@[target]
theorem mem_range_typein_iff (r : α → α → Prop) [IsWellOrder α r] {o} :
    o ∈ Set.range (typein r) ↔ o < type r := by sorry
...
theorem typein_surjOn (r : α → α → Prop) [IsWellOrder α r] :
    Set.SurjOn (typein r) Set.univ (Set.Iio (type r)) := by sorry
...
theorem enum_type {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r] [IsWellOrder β s]
    (f : s ≺i r) {h : type s < type r} : enum r ⟨type s, h⟩ = f.top := by sorry

@[target, simp]
theorem enum_typein (r : α → α → Prop) [IsWellOrder α r] (a : α) :
    enum r ⟨typein r a, typein_lt_type r a⟩ = a := by sorry
...
@[target]
theorem lt_wf : @WellFounded Ordinal (· < ·) := by sorry
...
theorem typein_apply {α β} {r : α → α → Prop} {s : β → β → Prop} [IsWellOrder α r] [IsWellOrder β s]
    (f : r ≼i s) (a : α) : typein s (f a) = typein r a := by sorry
...
@[target, simp]
theorem card_type (r : α → α → Prop) [IsWellOrder α r] : card (type r) = #α := by sorry

@[target, simp]
theorem card_typein {r : α → α → Prop} [IsWellOrder α r] (x : α) :
    #{ y // r y x } = (typein r x).card := by sorry

@[target]
theorem card_le_card {o₁ o₂ : Ordinal} : o₁ ≤ o₂ → card o₁ ≤ card o₂ := by sorry

@[target, simp]
theorem card_zero : card 0 = 0 := by sorry
...
theorem type_uLift (r : α → α → Prop) [IsWellOrder α r] :
    type (ULift.down ⁻¹'o r) = lift.{v} (type r) := by sorry

@[target]
theorem _root_.RelIso.ordinal_lift_type_eq {r : α → α → Prop} {s : β → β → Prop}
    [IsWellOrder α r] [IsWellOrder β s] (f : r ≃r s) : lift.{v} (type r) = lift.{u} (type s) := by sorry

@[target, simp]
theorem type_preimage {α β : Type u} (r : α → α → Prop) [IsWellOrder α r] (f : β ≃ α) :
    type (f ⁻¹'o r) = type r := by sorry
...
@[target, deprecated type_lift_preimage_aux (since := "2024-10-22")]
theorem type_lift_preimage_aux (r : α → α → Prop) [IsWellOrder α r] (f : β ≃ α) :
    lift.{u} (@type _ (fun x y => r (f x) (f y))
      (inferInstanceAs (IsWellOrder β (f ⁻¹'o r)))) = lift.{v} (type r) := by sorry
...
@[target, simp]
theorem lift_id : ∀ a, lift.{u, u} a = a := by sorry

/-- An ordinal lifted to the zero universe equals itself. -/
@[target, simp]
theorem lift_uzero (a : Ordinal.{u}) : lift.{0} a = a := by sorry

@[target]
theorem lift_type_le {α : Type u} {β : Type v} {r s} [IsWellOrder α r] [IsWellOrder β s] :
    lift.{max v w} (type r) ≤ lift.{max u w} (type s) ↔ Nonempty (r ≼i s) := by sorry

@[target]
theorem lift_type_eq {α : Type u} {β : Type v} {r s} [IsWellOrder α r] [IsWellOrder β s] :
    lift.{max v w} (type r) = lift.{max u w} (type s) ↔ Nonempty (r ≃r s) := by sorry
...
@[target, simp]
theorem lift_le {a b : Ordinal} : lift.{u, v} a ≤ lift.{u, v} b ↔ a ≤ b := by sorry

@[target, simp]
theorem lift_inj {a b : Ordinal} : lift.{u, v} a = lift.{u, v} b ↔ a = b := by sorry

@[target, simp]
theorem lift_lt {a b : Ordinal} : lift.{u, v} a < lift.{u, v} b ↔ a < b := by sorry

@[target, simp]
theorem lift_typein_top {r : α → α → Prop} {s : β → β → Prop}
    [IsWellOrder α r] [IsWellOrder β s] (f : r ≺i s) : lift.{u} (typein s f.top) = lift (type r) := by sorry
...
@[target, simp]
theorem liftInitialSeg_coe : (liftInitialSeg.{v, u} : Ordinal → Ordinal) = lift.{v, u} := by sorry

set_option linter.deprecated false in
@[target, deprecated liftInitialSeg_coe (since := "2024-09-21")]
theorem lift.initialSeg_coe : (lift.initialSeg.{v, u} : Ordinal → Ordinal) = lift.{v, u} := by sorry

@[target, simp]
theorem lift_lift (a : Ordinal.{u}) : lift.{w} (lift.{v} a) = lift.{max v w} a := by sorry

@[target, simp]
theorem lift_zero : lift 0 = 0 := by sorry

@[target, simp]
theorem lift_one : lift 1 = 1 := by sorry

@[target, simp]
theorem lift_card (a) : Cardinal.lift.{u, v} (card a) = card (lift.{u} a) := by sorry

@[target]
theorem mem_range_lift_of_le {a : Ordinal.{u}} {b : Ordinal.{max u v}} (h : b ≤ lift.{v} a) :
    b ∈ Set.range lift.{v} := by sorry
...
theorem le_lift_iff {a : Ordinal.{u}} {b : Ordinal.{max u v}} :
    b ≤ lift.{v} a ↔ ∃ a' ≤ a, lift.{v} a' = b := by sorry
...
@[target, simp]
theorem type_nat_lt : typeLT ℕ = ω := by sorry

@[target, simp]
theorem card_omega0 : card ω = ℵ₀ := by sorry
...
@[target, simp]
theorem card_add (o₁ o₂ : Ordinal) : card (o₁ + o₂) = card o₁ + card o₂ := by sorry

@[target, simp]
theorem type_sum_lex {α β : Type u} (r : α → α → Prop) (s : β → β → Prop) [IsWellOrder α r]
    [IsWellOrder β s] : type (Sum.Lex r s) = type r + type s := by sorry

@[target, simp]
theorem card_nat (n : ℕ) : card.{u} n = n := by sorry

@[target, simp]
theorem card_ofNat (n : ℕ) [n.AtLeastTwo] :
    card.{u} ofNat(n) = OfNat.ofNat n := by sorry
...
@[target]
theorem le_add_right (a b : Ordinal) : a ≤ a + b := by sorry

@[target]
theorem le_add_left (a b : Ordinal) : a ≤ b + a := by sorry

theorem max_zero_left : ∀ a : Ordinal, max 0 a = a :=
  max_bot_left

@[target]
theorem max_zero_right : ∀ a : Ordinal, max a 0 = a := by sorry
...
@[target, simp]
theorem sInf_empty : sInf (∅ : Set Ordinal) = 0 := by sorry
...
@[target, simp]
theorem add_one_eq_succ (o : Ordinal) : o + 1 = succ o := by sorry

@[target, simp]
theorem succ_zero : succ (0 : Ordinal) = 1 := by sorry

@[target, simp]
theorem succ_one : succ (1 : Ordinal) = 2 := by sorry

@[target]
theorem add_succ (o₁ o₂ : Ordinal) : o₁ + succ o₂ = succ (o₁ + o₂) := by sorry
...
@[target]
theorem succ_pos (o : Ordinal) : 0 < succ o := by sorry

@[target]
theorem succ_ne_zero (o : Ordinal) : succ o ≠ 0 := by sorry

@[target, simp]
theorem lt_one_iff_zero {a : Ordinal} : a < 1 ↔ a = 0 := by sorry

@[target]
theorem le_one_iff {a : Ordinal} : a ≤ 1 ↔ a = 0 ∨ a = 1 := by sorry

@[target, simp]
theorem card_succ (o : Ordinal) : card (succ o) = card o + 1 := by sorry

@[target]
theorem natCast_succ (n : ℕ) : ↑n.succ = succ (n : Ordinal) := by sorry
...
@[target, simp]
theorem typein_one_toType (x : toType 1) : typein (α := toType 1) (· < ·) x = 0 := by sorry
...
theorem typein_le_typein' (o : Ordinal) {x y : o.toType} :
    typein (α := o.toType) (· < ·) x ≤ typein (α := o.toType) (· < ·) y ↔ x ≤ y := by sorry

@[target]
theorem le_enum_succ {o : Ordinal} (a : (succ o).toType) :
    a ≤ enum (α := (succ o).toType) (· < ·) ⟨o, (type_toType _ ▸ lt_succ o)⟩ := by sorry
...
@[target]
theorem univ_id : univ.{u, u + 1} = typeLT Ordinal := by sorry

@[target, simp]
theorem lift_univ : lift.{w} univ.{u, v} = univ.{u, max v w} := by sorry

@[target]
theorem univ_umax : univ.{u, max (u + 1) v} = univ.{u, v} := by sorry
...
set_option linter.deprecated false in
@[target, deprecated liftPrincipalSeg_coe (since := "2024-09-21")]
theorem lift.principalSeg_coe :
    (lift.principalSeg.{u, v} : Ordinal → Ordinal) = lift.{max (u + 1) v} := by sorry

@[target, simp]
theorem liftPrincipalSeg_top : (liftPrincipalSeg.{u, v}).top = univ.{u, v} := by sorry

set_option linter.deprecated false in
@[target, deprecated liftPrincipalSeg_top (since := "2024-09-21")]
theorem lift.principalSeg_top : (lift.principalSeg.{u, v}).top = univ.{u, v} := by sorry

@[target]
theorem liftPrincipalSeg_top' : liftPrincipalSeg.{u, u + 1}.top = typeLT Ordinal := by sorry

set_option linter.deprecated false in
@[target, deprecated liftPrincipalSeg_top (since := "2024-09-21")]
theorem lift.principalSeg_top' : lift.principalSeg.{u, u + 1}.top = typeLT Ordinal := by sorry
...
@[target, simp]
theorem mk_toType (o : Ordinal) : #o.toType = o.card := by sorry
...
@[target]
theorem ord_eq_Inf (α : Type u) : ord #α = ⨅ r : { r // IsWellOrder α r }, @type α r.1 r.2 := by sorry

@[target]
theorem ord_eq (α) : ∃ (r : α → α → Prop) (wo : IsWellOrder α r), ord #α = @type α r wo := by sorry

@[target]
theorem ord_le_type (r : α → α → Prop) [h : IsWellOrder α r] : ord #α ≤ type r := by sorry

@[target]
theorem ord_le {c o} : ord c ≤ o ↔ c ≤ o.card := by sorry

@[target]
theorem gc_ord_card : GaloisConnection ord card := by sorry

@[target]
theorem lt_ord {c o} : o < ord c ↔ o.card < c := by sorry
...
@[target]
theorem card_surjective : Function.Surjective card := by sorry
...
@[target]
theorem lt_ord_succ_card (o : Ordinal) : o < (succ o.card).ord := by sorry

@[target]
theorem card_le_iff {o : Ordinal} {c : Cardinal} : o.card ≤ c ↔ o < (succ c).ord := by sorry
...
@[target, mono]
theorem ord_strictMono : StrictMono ord := by sorry

@[target, mono]
theorem ord_mono : Monotone ord := by sorry

@[target, simp]
theorem ord_le_ord {c₁ c₂} : ord c₁ ≤ ord c₂ ↔ c₁ ≤ c₂ := by sorry

@[target, simp]
theorem ord_lt_ord {c₁ c₂} : ord c₁ < ord c₂ ↔ c₁ < c₂ := by sorry

@[target, simp]
theorem ord_zero : ord 0 = 0 := by sorry

@[target, simp]
theorem ord_nat (n : ℕ) : ord n = n := by sorry

@[target, simp]
theorem ord_one : ord 1 = 1 := by sorry

@[target, simp]
theorem ord_ofNat (n : ℕ) [n.AtLeastTwo] : ord ofNat(n) = OfNat.ofNat n := by sorry

@[target, simp]
theorem ord_aleph0 : ord.{u} ℵ₀ = ω := by sorry
...
@[target]
theorem mk_ord_toType (c : Cardinal) : #c.ord.toType = c := by sorry
...
theorem card_typein_lt (r : α → α → Prop) [IsWellOrder α r] (x : α) (h : ord #α = type r) :
    card (typein r x) < #α := by sorry

@[target]
theorem card_typein_toType_lt (c : Cardinal) (x : c.ord.toType) :
    card (typein (α := c.ord.toType) (· < ·) x) < c := by sorry

@[deprecated card_typein_toType_lt (since := "2024-08-26")]
alias card_typein_out_lt := card_typein_toType_lt

@[target]
theorem mk_Iio_ord_toType {c : Cardinal} (i : c.ord.toType) : #(Iio i) < c := by sorry

@[deprecated "No deprecation message was provided."  (since := "2024-08-26")]
alias mk_Iio_ord_out_α := mk_Iio_ord_toType

@[target]
theorem ord_injective : Injective ord := by sorry

@[target, simp]
theorem ord_inj {a b : Cardinal} : a.ord = b.ord ↔ a = b := by sorry

@[target, simp]
theorem ord_eq_zero {a : Cardinal} : a.ord = 0 ↔ a = 0 := by sorry

@[target, simp]
theorem ord_eq_one {a : Cardinal} : a.ord = 1 ↔ a = 1 := by sorry

@[target, simp]
theorem omega0_le_ord {a : Cardinal} : ω ≤ a.ord ↔ ℵ₀ ≤ a := by sorry

@[target, simp]
theorem ord_le_omega0 {a : Cardinal} : a.ord ≤ ω ↔ a ≤ ℵ₀ := by sorry

@[target, simp]
theorem ord_lt_omega0 {a : Cardinal} : a.ord < ω ↔ a < ℵ₀ := by sorry

@[target, simp]
theorem omega0_lt_ord {a : Cardinal} : ω < a.ord ↔ ℵ₀ < a := by sorry

@[target, simp]
theorem ord_eq_omega0 {a : Cardinal} : a.ord = ω ↔ a = ℵ₀ := by sorry
...
@[target, simp]
theorem ord.orderEmbedding_coe : (ord.orderEmbedding : Cardinal → Ordinal) = ord := by sorry
...
@[target]
theorem univ_id : univ.{u, u + 1} = #Ordinal := by sorry
...
@[target]
theorem lift_lt_univ' (c : Cardinal) : lift.{max (u + 1) v, u} c < univ.{u, v} := by sorry

@[target, simp]
theorem ord_univ : ord univ.{u, v} = Ordinal.univ.{u, v} := by sorry
...
@[target]
theorem lt_univ' {c} : c < univ.{u, v} ↔ ∃ c', c = lift.{max (u + 1) v, u} c' := by sorry

@[target]
theorem small_iff_lift_mk_lt_univ {α : Type u} :
    Small.{v} α ↔ Cardinal.lift.{v+1,_} #α < univ.{v, max u (v + 1)} := by sorry
...
@[target, simp]
theorem card_univ : card univ.{u,v} = Cardinal.univ.{u,v} := by sorry

@[target, simp]
theorem nat_le_card {o} {n : ℕ} : (n : Cardinal) ≤ card o ↔ (n : Ordinal) ≤ o := by sorry

@[target, simp]
theorem one_le_card {o} : 1 ≤ card o ↔ 1 ≤ o := by sorry

@[target, simp]
theorem ofNat_le_card {o} {n : ℕ} [n.AtLeastTwo] :
    (ofNat(n) : Cardinal) ≤ card o ↔ (OfNat.ofNat n : Ordinal) ≤ o := by sorry

@[target, simp]
theorem aleph0_le_card {o} : ℵ₀ ≤ card o ↔ ω ≤ o := by sorry

@[target, simp]
theorem card_lt_aleph0 {o} : card o < ℵ₀ ↔ o < ω := by sorry

@[target, simp]
theorem nat_lt_card {o} {n : ℕ} : (n : Cardinal) < card o ↔ (n : Ordinal) < o := by sorry

@[target, simp]
theorem zero_lt_card {o} : 0 < card o ↔ 0 < o := by sorry

@[target, simp]
theorem one_lt_card {o} : 1 < card o ↔ 1 < o := by sorry
...
@[target, simp]
theorem card_lt_nat {o} {n : ℕ} : card o < n ↔ o < n := by sorry

@[target, simp]
theorem card_lt_ofNat {o} {n : ℕ} [n.AtLeastTwo] :
    card o < ofNat(n) ↔ o < OfNat.ofNat n := by sorry

@[target, simp]
theorem card_le_nat {o} {n : ℕ} : card o ≤ n ↔ o ≤ n := by sorry

@[target, simp]
theorem card_le_one {o} : card o ≤ 1 ↔ o ≤ 1 := by sorry
...
@[target, simp]
theorem card_eq_nat {o} {n : ℕ} : card o = n ↔ o = n := by sorry

@[target, simp]
theorem card_eq_zero {o} : card o = 0 ↔ o = 0 := by sorry

@[target, simp]
theorem card_eq_one {o} : card o = 1 ↔ o = 1 := by sorry

@[target]
theorem mem_range_lift_of_card_le {a : Cardinal.{u}} {b : Ordinal.{max u v}}
    (h : card b ≤ Cardinal.lift.{v, u} a) : b ∈ Set.range lift.{v, u} := by sorry

@[target, deprecated mem_range_lift_of_card_le (since := "2024-10-07")]
theorem lift_down' {a : Cardinal.{u}} {b : Ordinal.{max u v}}
    (h : card.{max u v} b ≤ Cardinal.lift.{v, u} a) : ∃ a', lift.{v, u} a' = b := by sorry
...
theorem type_fintype (r : α → α → Prop) [IsWellOrder α r] [Fintype α] :
    type r = Fintype.card α := by sorry

@[target]
theorem type_fin (n : ℕ) : typeLT (Fin n) = n := by sorry
...
theorem List.Sorted.lt_ord_of_lt [LinearOrder α] [WellFoundedLT α] {l m : List α}
    ...
    (hlt : ∀ i ∈ l, Ordinal.typein (α := α) (· < ·) i < o) :
      ∀ i ∈ m, Ordinal.typein (α := α) (· < ·) i < o := by sorry
