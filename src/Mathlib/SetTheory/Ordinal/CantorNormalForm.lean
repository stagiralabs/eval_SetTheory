...
@[target, simp]
theorem CNF_zero (b : Ordinal) : CNF b 0 = [] := by sorry

/-- Recursive definition for the Cantor normal form. -/
@[target]
theorem CNF_ne_zero {b o : Ordinal} (ho : o ≠ 0) :
    CNF b o = (log b o, o / b ^ log b o)::CNF b (o % b ^ log b o) := by sorry

@[target]
theorem zero_CNF {o : Ordinal} (ho : o ≠ 0) : CNF 0 o = [(0, o)] := by sorry

@[target]
theorem one_CNF {o : Ordinal} (ho : o ≠ 0) : CNF 1 o = [(0, o)] := by sorry

@[target]
theorem CNF_of_le_one {b o : Ordinal} (hb : b ≤ 1) (ho : o ≠ 0) : CNF b o = [(0, o)] := by sorry
...
theorem CNF_fst_le_log {b o : Ordinal.{u}} {x : Ordinal × Ordinal} :
    x ∈ CNF b o → x.1 ≤ log b o := by sorry

/-- Every exponent in the Cantor normal form `CNF b o` is less or equal to `o`. -/
@[target, deprecated CNF_fst_le_log (since := "2024-09-21")]
theorem CNF_fst_le {b o : Ordinal.{u}} {x : Ordinal × Ordinal} (h : x ∈ CNF b o) : x.1 ≤ o := by sorry
...
theorem CNF_snd_lt {b o : Ordinal.{u}} (hb : 1 < b) {x : Ordinal × Ordinal} :
    x ∈ CNF b o → x.2 < b := by sorry

/-- The exponents of the Cantor normal form are decreasing. -/
@[target]
theorem CNF_sorted (b o : Ordinal) : ((CNF b o).map Prod.fst).Sorted (· > ·) := by sorry
